...
public class EditarAlumno extends JFrame {
    ...
    public EditarAlumno() {
        ...
        txtNombre = new JTextField(); formPanel.add(txtNombre);

        formPanel.add(new JLabel("Apellido Paterno"));
        txtApPaterno = new JTextField(); formPanel.add(txtApPaterno);

        formPanel.add(new JLabel("Apellido Materno"));
        txtApMaterno = new JTextField(); formPanel.add(txtApMaterno);

        formPanel.add(new JLabel("Correo"));
        txtCorreo = new JTextField(); formPanel.add(txtCorreo);

        formPanel.add(new JLabel("Teléfono (10 dígitos)"));
        txtTelefono = new JTextField(); formPanel.add(txtTelefono);

        formPanel.add(new JLabel("Número de Control"));
        txtControl = new JTextField(); formPanel.add(txtControl);
